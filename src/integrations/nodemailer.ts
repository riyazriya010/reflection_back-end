...
class Mail {
    ...
    public sendFeedbackRequestMail(email: string, feedbackLink: string, receiverName: string, name: string, expireDate: any): Promise<any> {
...
`;
    ...
    public sendRemainderMail(email: string, feedbackLink: string, requesterName: string, responderName: string): Promise<any> {
        this.mailOptions.to = email;
...
`;
    ...
    public sendDeadlineRemainderMail(
        email: string,
        receiverName: string,
